...
public class KryoReflectionFactory extends KryoReflectionFactorySupport {
	public KryoReflectionFactory() {
		...
		setReferences(true); 
		register(RpcMessage.class, new KryoRpcMessageSerializer());
		register(RpcRequest.class, new KryoRpcRequestSerializer());
		register(RpcResponse.class, new KryoRpcResponseSerializer());
